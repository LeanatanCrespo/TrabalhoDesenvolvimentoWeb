async function registrausuario() {
    ...
    let data = await fetch("http://localhost:8000/src/api/usuario", {
        method: "POST",
...
async function fetchUsuarios() {
    try {
        const response = await fetch("http://localhost:8000/src/api/usuario", {
...
async function fetchUsuario(id) {
    let usuarios = await fetch(`http://localhost:8000/src/api/usuario?id=${id}`, {
        method: "GET",
